...
public interface WhileListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link WhileParser#decFunction}.
	 * @param ctx the parse tree
	 */
	void enterDecFunction(WhileParser.DecFunctionContext ctx);
	/**
	 * Exit a parse tree produced by {@link WhileParser#decFunction}.
	 * @param ctx the parse tree
	 */
	void exitDecFunction(WhileParser.DecFunctionContext ctx);
	/**
